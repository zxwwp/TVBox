var rule = {
    ...
    url:'/fyclass',
    class_name:'NBA篮球&CBA篮球&足球&乒乓球&羽毛球&斯诺克&网球',
    class_url:'lanqiu/nba/&lanqiu/cba/&zuqiu&zonghe/pingpangqiu/&zonghe/yumaoqiu/&zonghe/sinuoke/&zonghe/wangqiu/', 
    headers:{
    ...
    二级:{
        ...
        content:".msg ul&&Text",
        tabs:"js:TABS=['【直播源】']",
        lists:"js:LISTS=[];pdfh=jsp.pdfh;pdfa=jsp.pdfa;pd=jsp.pd;let html=request(input);let data=pdfa(html,'#downinfo-detail&&p');TABS.forEach(function(tab){let d=data.map(function(it){let name=pdfh(it,'rel&&Text');let url=pd(it,'a&&href');return name+'$'+url});LISTS.push(d)});"
        },
   搜索:'',
}