var rule = {
    ...
    二级:{title:'.live-title&&Text;.live-title&&Text',img:'img:eq(1)&&src',desc:';;;.live-left-team-sj&&Text;.live-right-team-sj&&Text',content:'.live-info&&Text',tabs:"js:TABS=['直播信号:']",lists:'.singldl a',list_text:'a&&Text',list_url:'a&&data-url'},
    搜索:'',
}
