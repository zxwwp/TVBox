var rule = {
    ...
    二级:{title:'.live-title&&Text;.live-title&&Text',desc:';;;.live-left-team-sj&&Text;.live-right-team-sj&&Text',content:'.live-info&&Text',tabs:"js:TABS=['【直播源】']",lists:'.box:eq(#id)&&.singldl dd',list_text:'a&&Text',list_url:'a&&data-url'},
    搜索:'',
}