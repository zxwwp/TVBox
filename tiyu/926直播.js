var rule = {
    ...
    一级:'.list_content a;.jiabifeng&&p:lt(5)&&Text;img&&op-zfr-a-g;p.eventtime_wuy.eventtime:ep(1)&&Text;a&&href', 
    二级:'*', 
    ...
    //二级:{title:'.live-title&&Text;.live-title&&Text',desc:';;;.live-left-team-sj&&Text;.live-right-team-sj&&Text',content:'.live-info&&Text',tabs:"js:TABS=['【直播源】']",lists:'dl.singldl span.diss',list_text:'a&&Text',list_url:'a&&data-url'},
    搜索:'',
}