var rule = {
    ...
    二级:{title:'.msg ul&&Text;.msg ul&&Text',img:'img:eq(2)&&src',desc:';;;.nameOne&&Text;.nameTwo&&Text',content:'._t&&Text',tabs:"js:TABS=['直播信号:']",lists:'.checkChannel li:gt(1)',list_text:'a&&Text',list_url:'a&&data-url'},
    搜索:'',
}