var rule = {
    ...
    二级:{title:'.msg ul&&Text;.msg ul&&Text',img:'img:eq(2)&&src',desc:';;;.nameOne&&Text;.nameTwo&&Text',content:'._t&&Text',tabs:"js:TABS=['直播信号源']",lists:'.sig-list',lists:'#item-source a',list_text:'a&&Text',list_url:'a&&data-url'},
    搜索:'',
} 