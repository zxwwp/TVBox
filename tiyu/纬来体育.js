var rule = {
    ...
    推荐:'*',
      ...
      一级:"js:var items=[];pdfh=jsp.pdfh;pdfa=jsp.pdfa;pd=jsp.pd;var html=request(input);var tabs=pdfa(html,'body&&.clearfix');tabs.forEach(function(it){var  pz=pdfh(it,'div:eq(0)&&a:gt(2):lt(3)&&Text');var ps=pdfh(it,'a.zban_wrap p:eq(2)&&Text');var img=pd(it,'img&&data-original');var timer=pdfh(it,'a.zban_wrap p:eq(1)&&Text');var url=pd(it,'a&&href');items.push({desc:timer+'  '+ps,title:pz,pic_url:img,url:url})});setResult(items);",
