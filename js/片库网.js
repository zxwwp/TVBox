var rule={
   ...
   // headers:{'User-Agent':'PC_UA', },
    ...
    double:true,
    一级:'.col-lg-8.col-md-6.col-sm-4.col-xs-3&&.myui-vodlist__box;h4.title.text-overflow&&Text;a.myui-vodlist__thumb.lazyload&&data-original;span.pic-tag.pic-tag-top&&Text;a&&href',
   二级:{
