var rule={
    ...
    推荐:'',
    double:true,
    一级:'.vodlist.hotgrow.size.listdh.top20.wow.fadeInUp.animated&&.pack-ykpack&&.pack-packcover.returl.list-top-b;a&&title;div&&data-original;span.pack-prb.hidden&&Text;a&&href',
   二级:{
