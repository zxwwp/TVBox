...
"3":[
  ...
  {"n":"2010","v":"/year/2010"}]}]
   ...
   一级:"js:var items=[];pdfh=jsp.pdfh;pdfa=jsp.pdfa;pd=jsp.pd;var html=request(input);var tabs=pdfa(html,'body&&.pack-ykpack');tabs.forEach(function(it){var  pz=pdfh(it,'a&&title');var ps=pdfh(it,'.pack-prb&&Text');var img=pd(it,'img&&data-original');var timer=pdfh(it,'.pack-subtitle&&Text');var url=pd(it,'a&&href');items.push({desc:timer+'  '+ps,title:pz,pic_url:img,url:url})});setResult(items);",
   二级:{
