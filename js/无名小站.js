...
"2":[
  ...
  {"n":"2010","v":"/year/2010"}]}]
    ...
    class_url:'1&2&3&4&5',
    detailUrl:'/vodplay/fyid-fyclass-1/',
    play_parse:true,
    detailUrl:'',
    lazy:"",
    limit:6,
    ...
    一级:'.mdui-m-t-2&&li;.star-up-name&&Text;.lazy&&data-original;.vod_remarks&&Text;.vod_link_slide&&href',
    二级访问前:'log(MY_URL);let jump=request(MY_URL).match(/href="/voddetail&&/)[1];log(jump);MY_URL=urljoin2(MY_URL,jump)',
    二级:{
